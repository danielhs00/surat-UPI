        ...
        <div class="col-lg-12 p-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('operator.template.update', $template->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="file_docx" class="form-control @error('file_docx') is-invalid @enderror"
                                accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                            @error('file_docx')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted d-block mt-1">Kosongkan jika tidak ingin mengganti file template.</small>
                        </div>
