      ...
      <div class="dropdown-menu pc-h-dropdown drp-search">
        <form class="px-3">
          <div class="form-group mb-0 d-flex align-items-center">
            ...
            <input type="search" class="form-control border-0 shadow-none" placeholder="Cari disini. . .">
          </div>
        </form>
      </div>
    </li>
  ...
  <div class="col-lg-12 p-4">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('operator.template.store') }}" method="POST">
          @csrf
          ...
          {{-- Link Google Docs --}}
          <div class="mb-3">
            <label class="form-label">Link Google Docs</label>
            <input
              type="url"
              name="google_docs_url"
              class="form-control @error('google_docs_url') is-invalid @enderror"
              value="{{ old('google_docs_url') }}"
              placeholder="https://docs.google.com/document/d/...."
              required
            >
            @error('google_docs_url')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror

            <small class="text-muted">
              Pastikan link Google Docs sudah di-share minimal "Anyone with the link can view".
            </small>
          </div>
...
<!-- [ Main Content ] end -->
    <footer class="pc-footer">
        ...
        <div class="row">
            ...
            <p class="m-0"
                >Surat UPI | dibuat oleh Mirza & Daniel.</p
            >
        </div>
