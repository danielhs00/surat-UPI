            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-3">{{ $jumlah_mahasiswa ?? 0 }}<span
                                    class="badge bg-light-primary border border-primary"></span></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Total Surat Masuk</h6>
                            <h4 class="mb-3">{{ $jumlah_operator ?? 0 }}<span
                                    class="badge bg-light-success border border-success"></span></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Total Surat Berhasil</h6>
                            <h4 class="mb-3">{{ $jumlah_operator ?? 0 }}<span
                                    class="badge bg-light-success border border-success"></span></h4>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Total Surat</h6>
                            <h4 class="mb-3">18,800 <span
                                    class="badge bg-light-warning border border-warning"></span></h4>
                        </div>
                    </div>
                </div>
                                ...
                                <table id="pengajuanTable" class="table table-hover table-borderless mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>355</td>
                                            <td><span class="d-flex align-items-center gap-2"><i
                                                        class="fas fa-circle text-success f-10 m-r-5"></i>Disetujui</span>
                                            </td>
                                            <td class="text-end">$180,139</td>
                                        </tr>
                                        <tr>
        ...
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col-sm my-1">
                    <p class="m-0">Surat UPI | dibuat oleh Mirza & Daniel.</p>
                </div>
