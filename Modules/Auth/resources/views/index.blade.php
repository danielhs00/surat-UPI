    ...
    <div class="auth-main">
        <div class="auth-wrapper v3">
            <div class="auth-form">
                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="justify-content-between align-items-centet mb-4">
                            <h3 class="mb-0 text-center"><b>Login Surat UPI</b></h3>
                        </div>
                        <form action="{{ route('login.mahasiswa') }}">
                ...
                <div class="auth-footer row">
                    ...
                    <div class="col my-1">
                        <p class="m-0">Website <a href="{{ route('login.operator') }}">Surat UPI</a></p>
                    </div>
                    <!-- </div> -->
                </div>
            </div>
